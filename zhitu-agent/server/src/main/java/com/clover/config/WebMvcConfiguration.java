...
import com.clover.interceptor.PageAuthInterceptor;
...
public class WebMvcConfiguration extends WebMvcConfigurationSupport {
    ...
    protected void addInterceptors(InterceptorRegistry registry) {
        ...
        registry.addInterceptor(pageAuthInterceptor)
                ...
                .addPathPatterns("/task-manager")
                .addPathPatterns("/weather-planner")
                .addPathPatterns("/file-manager")
                .addPathPatterns("/travel-planner")
